...
export default function GenericTemplate({ data }: { data: TemplateData }) {
  const color = data.primaryColor || "#6B4FE0";
  const days = [
    "Monday",
    "Tuesday",
    "Wednesday",
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {data.services.map((item, i) => (
              <div
                key={i}
                className="group rounded-2xl border border-gray-100 bg-gray-50 p-6 transition-all hover:border-gray-200 hover:shadow-md"
              >
                <div
